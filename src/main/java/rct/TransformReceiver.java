...
public class TransformReceiver {
     ...
     *
     */
    public Transform lookupTransform(String target_frame, String source_frame, long time) throws TransformerException {
     ...
     * @param fixed_frame The frame in which to assume the transform is constant in
     * time.
     * @return The transform between the frames
     * @throws TransformerException
     */
    public Transform lookupTransform(String target_frame, long target_time, String source_frame, long source_time, String fixed_frame) throws TransformerException {
     ...
     *
     */
    public Future<Transform> requestTransform(String target_frame, String source_frame, long time) {
     ...
     * @param source_frame frame from which to transform
     ...
     * @param fixed_frame The frame in which to treat the transform as ant in time
     * @return True if the transform is possible, false otherwise
     */
    public boolean canTransform(String target_frame, long target_time, String source_frame, long source_time, String fixed_frame) {
