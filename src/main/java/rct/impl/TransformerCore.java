...
public interface TransformerCore extends TransformListener {
     ...
     * @param sourceFrame The frame where the data originated
     * @param sourcTime The time at which the sourceFrame should be evaluated. (0 will get the latest)
     * @param fixedFrame The frame in which to assume the transform is ant in time.
     * @return The transform between the frames
     * @throws TransformerException
     *
     */
    Transform lookupTransform(String targetFrame, long target_time, String sourceFrame, long sourcTime, String fixedFrame) throws TransformerException;
     ...
     * @param frameIdStr The frame id in question
     */
    boolean frameExists(String frameIdStr);
